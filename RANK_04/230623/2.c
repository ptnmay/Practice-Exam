...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/23 06:08:42 by psaeyang          #+#    #+#             */
/*   Updated: 2023/06/23 06:26:13 by psaeyang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int cd(char **av, int i) {
	if (i != 2)
		return(perr("error: cd: bad sv\n"), 1);
	else if (chdir(av[1]) == -1)
		return(perr("error: cd: cant to "), perr(av[1]), perr("\n"), 1);
	return 0;
}
